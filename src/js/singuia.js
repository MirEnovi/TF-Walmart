renderInfo = data => {
  const container = document.getElementById("cardAsociado");
    ...
    <li class="collection-item avatar">
      ...
      <input type="text" id="myTextResponse" value= "@${data[prop].user.screenName} " placeholder="Escribe tu respuesta" class="inp"><a class='btn-send send right-align send' data-message="${data[prop].user.screenName}"><i class="fab fa-telegram-plane"></i></a>
</ul>`;
      };
